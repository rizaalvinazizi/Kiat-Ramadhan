 ...
 * @author rizaalvin
 */
public class Itikaf extends javax.swing.JFrame {

    /**
     * Creates new form Itikaf
     */
    public Itikaf() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea7.setText("Yakni menetapi masjid dan berdiam di dalamnya dengan niat mendekatkan diri kepada Allah. \n\n“Bila masuk 10 (hari terakhir bulan Ramadhan) Nabi n me-ngencangkan kainnya (menjauhkan diri dari menggauli istrinya), menghidupkan malamnya dengan ibadah dan\n membangunkan keluarganya”. (HR. al-Bukhari).\n\n“Bahwasanya Nabi n senantiasa ber’itikaf pada 10 hari terakhir bulan Ramadhan hingga Allah mewafatkan beliau”. (HR. al-Bukhari dan Muslim)");
        jTextArea7.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jTextArea7.setEnabled(false);
        jScrollPane7.setViewportView(jTextArea7);

        getContentPane().add(jScrollPane7);
        jScrollPane7.setBounds(10, 280, 1340, 110);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Itikaf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
