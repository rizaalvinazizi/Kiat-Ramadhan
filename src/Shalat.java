 ...
 * @author rizaalvin
 */
public class Shalat extends javax.swing.JFrame {

    /**
     * Creates new form Shalat
     */
    public Shalat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Shalat Tarawih");
        jPanel1.add(jLabel1);
        ...
        jTextArea7.setText("Nabi n bersabda, “Barangsiapa menunaikan qiyamullail pada bulan Ramadhan, karena keimanan dan mengharapkan pahala, niscaya diampuni dosanya yang telah lalu.”\n(HR. al-Bukhari dan Muslim).\n\n\n“Siapa saja yang shalat Tarawih bersama imam hingga selesai, akan ditulis baginya pahala shalat semalam suntuk”. \n(HR. Abu Dawud, at-Tirmidzi, an-Nasa’i dan Ibnu Majah).");
        jTextArea7.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jTextArea7.setEnabled(false);
        jScrollPane7.setViewportView(jTextArea7);

        getContentPane().add(jScrollPane7);
        jScrollPane7.setBounds(10, 280, 1340, 140);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Shalat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
